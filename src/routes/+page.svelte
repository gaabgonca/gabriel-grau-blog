...
>
	...
	<a href="/cloud"
		>
		<!-- <i
			class="fixed bottom-7 md:bottom-8 left-4 md:left-8 w-auto z-40 w-4 h-4 fa fa-solid fa-braille scale-150"
		/> -->
		<i class="fixed bottom-7 md:bottom-8 left-4 md:left-8 w-auto z-40 w-4 h-4">
